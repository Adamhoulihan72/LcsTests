...
namespace lcsFirstSteps.Models
{
    ...
    /// <summary>The manage logins view model.</summary>
    ...
    /// <summary>The factor view model.</summary>
    ...
    /// <summary>The set password view model.</summary>
    ...
    /// <summary>The change password view model.</summary>
    ...
    /// <summary>The add phone number view model.</summary>
    ...
    /// <summary>The verify phone number view model.</summary>
    ...
    /// <summary>The configure two factor view model.</summary>
